...
use R3H6\FormTranslator\Facade\FormPersistenceManagerV12;
...
return function (ContainerConfigurator $container, ContainerBuilder $containerBuilder) {
    ...
    if (version_compare(VersionNumberUtility::getCurrentTypo3Version(), '13.0.0', '<')) {
        $containerBuilder->setAlias(FormPersistenceManagerInterface::class, FormPersistenceManagerV12::class);
        return;
    }
